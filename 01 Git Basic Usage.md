...
![image-20210419205822992](D:\Github\ROS-Learning\imgs\image-20210419205822992.png)
...
![img](D:\Github\ROS-Learning\imgs\git-process.png)
...
![img](D:\Github\ROS-Learning\imgs\1352126739_7909.jpg)
...
- （<font color=red>**危险操作**</font>）当执行 **`git checkout .`** 或者 **`git checkout -- <file>`** 命令时，会**用暂存区全部或指定的文件替换工作区的文件**。这个操作很危险，会清除工作区中未添加到暂存区的改动。
- （<font color=red>**危险操作**</font>）当执行 **`git checkout HEAD .`** 或者 **`git checkout HEAD <file>`** 命令时，会用 HEAD 指向的 master 分支中的全部或者部分文件替换暂存区和以及工作区中的文件。这个命令也是极具危险性的，不但会清除工作区中未提交的改动，也会清除暂存区中未提交的改动。

![image-20210422230424670](D:\Github\ROS-Learning\imgs\image-20210422230424670.png)

![image-20210422230442716](D:\Github\ROS-Learning\imgs\image-20210422230442716.png)

![image-20210422230506625](D:\Github\ROS-Learning\imgs\image-20210422230506625.png)
